...
if __name__ == '__main__':
    ...
    results = model.train(data='dataset/data.yaml', epochs=500, imgsz=640, batch=64, patience=100, lr0=0.01, lrf=0.001,
                          hsv_v=0.2, translate= 0.23, degrees=35, scale=0.3, perspective=0.05, device=gpu)
